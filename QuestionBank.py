...
if __name__ == "__main__":
    ...
    question_bank = QuestionBank("data/questions_section1.json")
    ...
    question_bank.add_question("Geography", new_question)

    # Get a question by index
    question = question_bank.get_question("Geography", 0)
    print("Question:", question)

    # Get 2 random questions from a section
    random_questions = question_bank.get_random_questions("Geography", 2)
